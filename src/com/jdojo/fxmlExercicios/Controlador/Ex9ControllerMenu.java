...
public class Ex9ControllerMenu implements Initializable {
	...
	private void introducirServicios(ActionEvent event) {
		...
		FXMLLoader loader = new FXMLLoader(
				getClass().getResource("/com/jdojo/fxmlexercicios/Vista/Ex9InsertarServiciosVista.fxml"));
		try {
	...
	private void consultarServicios(ActionEvent event) {
		...
		FXMLLoader loader = new FXMLLoader(
				getClass().getResource("/com/jdojo/fxmlexercicios/Vista/Ex9ConsultaServiciosVista.fxml"));
		try {
			Parent root = loader.load();
