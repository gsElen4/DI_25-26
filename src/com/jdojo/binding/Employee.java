...
public class Employee {
	...
	// Obxecto auxiliar que xestiona os listeners que escoitan cambios nas
	// propiedades
	...
	public void setSalary(double newSalary) {
		...
		// Se hai listeners rexistrados, notificaráselles que o salario cambiou cando
		// chaman a setSalary().
		// O método recibe o nome da propiedade, o valor antigo e o valor novo.
		pcs.firePropertyChange("salary", oldSalary, newSalary);
	}

	// Método para rexistrar un listener (escoitador) que será notificado cando
	// cambie unha propiedade
