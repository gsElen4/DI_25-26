...
public class EmployeeTest {
	...
	// Este método é o listener: un obxecto coa implementación do método
	// propertyChange(PropertyChangeEvent evt) da interface PropertyChangeListener.
	// Unha implementación en Java é considerada un obxecto
