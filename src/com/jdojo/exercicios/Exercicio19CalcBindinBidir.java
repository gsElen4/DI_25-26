...
public class Exercicio19CalcBindinBidir extends Application {
		@Override
		public void start(Stage stage) {
			...
			cantidadeField.textProperty().bindBidirectional(prezoUnitario, new NumberStringConverter());
			descontoField.textProperty().bindBidirectional(prezoUnitario, new NumberStringConverter());
